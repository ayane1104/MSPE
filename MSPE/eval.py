...
def main():
    ...
    parser.add_argument('--dataset', default='coco',
                        help='coco or f30k')
    parser.add_argument('--data_path', default='/root/autodl-tmp/coco')
    ...
    for base in weights_bases:
        ...
        model_path = os.path.join(base, 'checkpoint_22.pth')
        print(model_path)
