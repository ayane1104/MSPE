...
class VSEModel(object):
    ...
    def forward_emb(self, images, captions, lengths, image_lengths=None):
        ...
        if self.opt.precomp_enc_type == 'basic':
            ...
            img_emb_mu, img_emb_var, img_emb = self.img_enc(images, image_lengths)
        else:
            if torch.cuda.is_available():
                images = images.cuda()
                captions = captions.cuda()
        ...
        cap_emb_mu, cap_emb_var, cap_emb = self.txt_enc(captions, lengths)
        # return img_emb, cap_emb
        return img_emb_mu, img_emb_var, img_emb, cap_emb_mu, cap_emb_var, cap_emb

    def forward_loss(self, img_emb_mu, img_emb_var, img_emb, cap_emb_mu, cap_emb_var, cap_emb):
        """Compute the loss given pairs of image and caption embeddings
        """
        loss = self.criterion(img_emb_mu, img_emb_var, img_emb, cap_emb_mu, cap_emb_var, cap_emb)
    ...
    def train_emb(self, images, captions, lengths, image_lengths=None, warmup_alpha=None):
        ...
        img_emb_mu, img_emb_var, img_emb, cap_emb_mu, cap_emb_var, cap_emb = self.forward_emb(images, captions, lengths, image_lengths=image_lengths)
        # measure accuracy and record loss
        self.optimizer.zero_grad()
        loss = self.forward_loss(img_emb_mu, img_emb_var, img_emb, cap_emb_mu, cap_emb_var, cap_emb)
